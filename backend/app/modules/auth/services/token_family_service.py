...
async def create_token_family(
    ...
    """Wrapper function for TokenFamilyService.create_token_family"""
...
async def check_token_family_revoked(
    ...
    """Wrapper function for TokenFamilyService.check_token_family_revoked"""
...
async def revoke_token_family(
    ...
    """Wrapper function for TokenFamilyService.revoke_token_family"""
...
async def revoke_entire_chain(db: AsyncSession, refresh_jti: str) -> int:
    """Wrapper function for TokenFamilyService.revoke_entire_chain"""
...
class TokenFamilyService:
    """Service quản lý token families và rotation"""
