...
--                     rag_documents, questionnaires, questions, answer_options   ← NEW v3.3.0
--   trg_chat_message_insert: auto-increment message_count + total_tokens_used + total_cost_usd
--
-- Partial unique indexes: 1
--   uq_questionnaires_active_wound_type: only 1 active questionnaire per wound_type   ← NEW v3.3.0
--
-- Fixes applied (v3.2.0 → v3.3.0):
--   🟢 questionnaires            → 3 bảng mới: questionnaires, questions, answer_options
--   🟢 partial unique index      → uq_questionnaires_active_wound_type
--   🟢 view                      → v_questionnaire_summary
--   🟢 permission                → admin:questionnaires
--   🟢 triggers                  → 3 updated_at triggers cho 3 bảng mới
--
